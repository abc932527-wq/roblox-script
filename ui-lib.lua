--[[
    VEIL UI LIBRARY v3.1 - PRODUCTION READY
    - Optimized rendering (zero lag)
    - Professional dark theme with purple accent
    - Smooth animations
    - Mobile + PC support
    - Clean API for all game scripts
]]
...
-- Utility: Create instance with children
...
function Library.new(title, gameTitle)
    ...
    closeBtn.MouseEnter:Connect(function()
        Tween(closeBtn, {BackgroundTransparency = 0.6, BackgroundColor3 = Theme.Red}, 0.15)
    end)
    closeBtn.MouseLeave:Connect(function()
        Tween(closeBtn, {BackgroundTransparency = 0.85, BackgroundColor3 = Theme.Red}, 0.15)
    end)
...
-- Add Keybind (RightShift toggle, End panic)
